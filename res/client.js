...
client_players_Youtube.prototype = {
	...
	,getRemoteDataFallback: function(url,callback) {
		...
		client_Utils.prepend(this.playerEl,video);
		this.tempYoutube = new YT.Player(video.id,{ videoId : this.extractVideoId(url), height: 360, width: 640, playerVars : { modestbranding : 1, rel : 0, showinfo : 0, controls : 0, disablekb : 1}, events : { onReady : function(e) {
			if(_gthis.playerEl.contains(video)) {
				_gthis.playerEl.removeChild(video);
			}
